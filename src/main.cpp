...
// Redirect to the real dashboard. The ESP32 only serves the REST API —
// the UI lives on the companion server (see smart-garden-server repo).
// Set DASHBOARD_URL in config.h to your server's address.
void handleRoot() {
    String html = String("<!DOCTYPE html><html><head>")
        + "<meta http-equiv='refresh' content='0;url=" + DASHBOARD_URL + "'>"
        + "<title>Smart Garden</title></head>"
        ...
        + "<p>Redirecting to <a href='" + DASHBOARD_URL + "' style='color:#4ecca3'>Smart Garden Dashboard</a>...</p>"
